...
def propagate_package():
    ...
    if (platform.system() == "Windows"):
        ...
        retcode = subprocess.call("c:/cygwin/bin/scp.exe -qi e:/packagebuilder/.packagebuilder.private_key.rsa -o StrictHostKeyChecking=no %s  biocadmin@merlot2:/loc/www/bioconductor-test.fhcrc.org/course-packages/bin/windows/contrib/2.12/" % package_name)
    else:
